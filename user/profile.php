...
?>
        ...
        <section class="vh-100">
            <div class="container py-5 h-70 plain">
                ...
                ?>
                                        ...
                                        <h2 class="fw-bold mb-2 text-uppercase">USER
                                            SINCE</br><?php echo($account['created_at']); ?></h2>
                                        ...
                                        <div class="form-outline row form-white">
                                            ...
                                            <div class="col-6">
                                                <input type="number" name="zip" id="zipcode"
                                                    class="form-control form-control-lg" pattern="\d*"
                                                    oninput="this.value=this.value.slice(0, this.maxLength)"
                                                    maxlength="5" value="<?php echo($account['zip']);?>" />
                                        ...
                                        <div class="mb-5">
                                            <a href="index.php?a=changepass" class="text-white-50 fw-bold">Change
                                                Password</a>
                                        </div>

                                        <button class="btn btn-outline-light btn-lg px-5" id="submitButton"
