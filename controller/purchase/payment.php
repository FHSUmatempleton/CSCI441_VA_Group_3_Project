...
$info['credit'] = filter_input(INPUT_POST, 'credit', FILTER_SANITIZE_STRING); //type
$info['cardtype'] = filter_input(INPUT_POST, 'cardtype', FILTER_SANITIZE_STRING); // date
$info['fName'] = filter_input(INPUT_POST, 'fName', FILTER_SANITIZE_STRING); //timeframe
$info['lName'] = filter_input(INPUT_POST, 'lName', FILTER_SANITIZE_STRING); //address
$info['exp'] = filter_input(INPUT_POST, 'exp', FILTER_SANITIZE_STRING); //state
$info['cvv'] = filter_input(INPUT_POST, 'cvv', FILTER_SANITIZE_STRING); //zipcode
